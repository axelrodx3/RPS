...
export const MOVE_LOCKED_MS = 1150;
export const MOVE_LOCKED_REDUCED_MS = 950;
export const WAITING_CPU_MS = 1650;
export const WAITING_CPU_REDUCED_MS = 1300;
export const REVEAL_PAUSE_MS = 1400;
export const REVEAL_PAUSE_REDUCED_MS = 1100;
export const REVEAL_DISPLAY_MS = 1100;
export const REVEAL_DISPLAY_REDUCED_MS = 750;
export const ROUND_RESULT_DISPLAY_MS = 3400;
export const ROUND_RESULT_DISPLAY_REDUCED_MS = 2600;
export const ROUND_INTRO_MS = 800;
export const ROUND_INTRO_REDUCED_MS = 500;
